...
#include "cmdutils_common_opts.h"
	...
	{ "k",             OPT_BOOL | OPT_EXPERT | OPT_OFFSET |
					   OPT_INPUT,                                   { .off = OFFSET(card) },
		 "card or not", "" },
	{ "key_loss",             OPT_BOOL | OPT_EXPERT | OPT_OFFSET |
                        OPT_INPUT,                                   { .off = OFFSET(key_loss) },
		"random loss packet", "" },
    ...
    { "only_key",        OPT_VIDEO | OPT_BOOL | OPT_EXPERT,                         { &intra_only },
        "deprecated use -g 1" },
