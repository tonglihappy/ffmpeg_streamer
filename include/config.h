...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=/usr/local/ffmpeg --enable-version3 --enable-gpl --disable-debug --disable-shared --enable-static --disable-doc --disable-ffserver --disable-ffprobe --disable-ffplay --disable-everything --enable-encoder=mpeg2video --enable-encoder=aac --enable-encoder=libx264 --enable-decoder=aac --enable-decoder=flv --enable-decoder=mpeg2video --enable-decoder=h264 --enable-decoder=mpeg2video --enable-parser=h264 --enable-parser=aac --enable-muxer=flv --enable-muxer=mp4 --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=mpegvideo --enable-protocol=rtmp --enable-protocol=http --enable-protocol=hls --enable-protocol=file --enable-libx264 --disable-w32threads --disable-debug --enable-pthreads --enable-network --disable-zlib --disable-bzlib --extra-cflags=-I/usr/local/libx264/include --extra-ldflags=-L/usr/local/libx264/lib --extra-libs=-ldl"
